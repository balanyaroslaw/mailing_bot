export enum Queries {
    ...
    GET_MYSTERIES = 'SELECT m.mysteries_id, m.text, c.comment_text FROM mysteries AS m JOIN mysteries_comments AS c ON m.mysteries_id = c.comment_id ORDER BY m.mysteries_id ASC;',
